...
from .models import BlogPost, Comment, CustomUser, ImageModel, Tag
...
class BlogPostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ("id", "author", "slug", "created_on", "updated_on")
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = "__all__"
        read_only_fields = ("id", "created_on", "author", "post")
